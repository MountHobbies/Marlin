...
#define STRING_CONFIG_H_AUTHOR "(MountHobbies, Ender 3 Pro V1.5 BTT Skr Mini e3V3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 Pro V1.5 SKR Mini e3 V3"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  24.94,  24.94 }
    #define DEFAULT_Ki_LIST {   2.34,   2.34 }
    #define DEFAULT_Kd_LIST {  66.35,  66.35 }
  #else
...
//#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 127.05
  #define DEFAULT_bedKi 24.06
  #define DEFAULT_bedKd 447.25
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -9, -1.75 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define ENABLE_LEVELING_FADE_HEIGHT
    ...
    #define DEFAULT_LEVELING_FADE_HEIGHT 7.0 // (mm) Default fade height.
  #endif
